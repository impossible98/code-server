...
//   }
//   return res.send(
//     await fs.readFile(path.join(vsRootPath, "out/vs/workbench/contrib/webview/browser/pre", req.params[0])),
//   )
// })
...
//     reconnectionToken: req.query.reconnectionToken as string,
//     reconnection: (req.query.reconnection as string) === "true",
//     skipWebSocketFrames: (req.query.skipWebSocketFrames as string) === "true",
//   }

//   const codeServerMain = await loadCodeServer()
//   codeServerMain.handleWebSocket(req.ws, connectionOptions, useCompression)
//   req.ws.resume()
// })
