...
/**
 * Options which defined per request, rather than defined once during
 */
interface IServerRequestWorkbenchConstructionOptions {
	/** Base path for all requests. This should be generated by an incoming request. */
	readonly base: string;
	/** Static assets path, derived from `base` and `commit` for cache busting. */
...
export {
	...
	IServerRequestWorkbenchConstructionOptions,
