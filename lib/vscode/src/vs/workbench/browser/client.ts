...
import { IServerWorkbenchConstructionOptions } from '../workbench.web.api';
 ...
 */
export const initialize = async (services: ServiceCollection, { productConfiguration }: IServerWorkbenchConstructionOptions): Promise<void> => {
