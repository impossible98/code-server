...
import type { IWorkbenchConstructionOptions, IWorkspace, IWorkbench, IServerWorkbenchConstructionOptions } from 'vs/workbench/workbench.web.api';
...
class BrowserMain extends Disposable {
	...
	async open(): Promise<IWorkbench> {
		...
		await initialize(services.serviceCollection, this.configuration as unknown as IServerWorkbenchConstructionOptions);
